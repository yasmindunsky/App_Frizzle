...
//
////    Lesson currentLesson = LessonActivity.getCurrentPractice();
...
//        numOfSlides = currentLesson.getNumOfSlides();
...
//        } else {
//            bundle.putInt("index", position - currentLesson.getNumOfSlides());
//        }
//
