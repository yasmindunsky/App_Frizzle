...
class PracticeContentParser {
    ...
    PracticeContentParser() {
    }

    Practice parsePractice(Context context, int practiceID, String lessonXmlName) throws XmlPullParserException {
    ...
    private Design getDesign()throws XmlPullParserException, IOException  {
        ...
        boolean withOnClickSet = xmlResourceParser.getAttributeBooleanValue(3, false);
        String onClickFunction = xmlResourceParser.getAttributeValue(2);
        xmlResourceParser.next();
        return new Design(runnable, withOnClickSet, onClickFunction);
    }
